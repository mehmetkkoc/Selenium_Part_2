...
public class C03_FileExists {
    ...
    public void test01() {
        ...
        // C:\Users\Mehmet yani benim bilgisayarimin bana ozel kismini verir

        //  "C:\Users\Mehmet\Downloads"

        // Masaustumuzdeki text dosyasinin varligini test edelim
        //"C:\Users\Mehmet\OneDrive\Masaüstü\text.txt"

        String dosyaYolu = System.getProperty("user.home")+"\\OneDrive\\Masaüstü";
